...
ActiveRecord::Schema.define(version: 2021_10_28_150822) do
  ...
  create_table "tag_to_gossips", force: :cascade do |t|
    t.bigint "tag_id"
    t.bigint "gossip_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gossip_id"], name: "index_tag_to_gossips_on_gossip_id"
    t.index ["tag_id"], name: "index_tag_to_gossips_on_tag_id"
  end
